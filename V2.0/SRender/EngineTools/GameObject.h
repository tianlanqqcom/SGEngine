...
namespace EngineTools
{
    ...
    class GameObject
    {
        std::map<size_t, Component *> componentList; // 组件列表
    ...
    public:
        ...
        Transform* transform = nullptr; // 快捷方式

        unsigned int UID; // 该物体的UID

        static unsigned int ObjectID; // 已经创建的物体个数
        ...
        [[nodiscard]] T *GetComponent() const
        {
            ...
            //    }
            //}
            auto it = componentList.find(typeid(T).hash_code());
